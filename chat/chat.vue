<template>
	<view>
		...
		<scroll-view scroll-y="true" class="msgLst" :style="{ height: scrollHeight + 'px' }"
			:scroll-into-view="scrollIntoView" scroll-with-animation="true" @scrolltoupper="loadMoreMsg()">
			...
			<view class="item" v-for="(msg, index) in msgList" :key="index" :id="'msg_' + index">
				<view v-if="msg.readStatus != -2" style="margin-bottom: 20rpx; font-size: 28rpx">
					<!-- 时间显示 -->
