<template>
	<view class="mine-container">
		<image
			class="image-bg"
			src="../static/imgs/mine/background.png"
			mode="aspectFill"
		></image>
		<view class="mine-content-main">
			<view
				class="mine-top"
				:style="{
					height: inviteCode ? '280rpx' : '180rpx',
					'padding-top': inviteCode ? '112rpx' : '130rpx',
				}"
			>
				...
				>
					<view class="mine-img-div">
						<image
							src="../static/imgs/mine/avatar.png"
							class="mine-img"
						></image>
					</view>
				...
				<view
					class="mine-headPic"
					v-else
					@click="goSelPage('../my/updateMyMsg')"
				>
					<view class="mine-img-div">
						<image
							v-if="headPic"
							:src="this.baseFileUrl + '/file/' + headPic"
							mode="aspectFill"
							class="mine-img"
						>
						</image>
				...
				<view v-if="inviteCode" class="share-invite">
					<view class="share-btn" @click="goIndex"> 推广中心 </view>
				</view>
			</view>
			...
			<view class="mine-main">
				<view class="main-top">
					...
					>
						<view class="top-one">
							<view class="one-font">
								<image
									style="width: 46rpx; height: 46rpx; margin-right: 26rpx"
									src="../static/imgs/mine/001.png"
									mode="aspectFill"
								></image>
								<text>管理模块</text>
							</view>
				...
				<view class="main-top main-center">
					<view v-if="role == 'indi'">
						<view class="top-one" @click="goSelPage('../watch/orderList')">
							<view class="one-font">
								<image
									style="width: 46rpx; height: 46rpx; margin-right: 26rpx"
									src="../static/imgs/mine/002.png"
									mode="aspectFill"
								></image>
								<text>我的订单</text>
							</view>
					...
					<view @click="goSelPage('../my/collectGoods')">
						<view class="top-one">
							<view class="one-font">
								<image
									style="width: 46rpx; height: 46rpx; margin-right: 26rpx"
									src="../static/imgs/mine/003.png"
									mode="aspectFill"
								></image>
								<text>商品收藏</text>
							</view>
					...
					<view @click="goSelPage('../my/footprint')">
						<view class="top-one">
							<view class="one-font">
								<image
									style="width: 46rpx; height: 46rpx; margin-right: 26rpx"
									src="../static/imgs/mine/004.png"
									mode="aspectFill"
								></image>
								<text>浏览记录</text>
							</view>
				...
				<view class="main-top main-center">
					<view @click="goSelPage('../common/service')">
						<view class="top-one">
							<view class="one-font">
								<image
									style="width: 46rpx; height: 46rpx; margin-right: 26rpx"
									src="../static/imgs/mine/005.png"
									mode="aspectFill"
								></image>
								<text>人工客服</text>
							</view>
				...
				<view class="login-page">
					<uni-popup ref="popup" type="center">
						<view class="popup-container">
							...
							<view class="popup-login" @click="goToLogin"> 立即登录 </view>
...
export default {
	...
	methods: {
		...
		handleShare() {
			...
			/*#ifdef APP-PLUS*/
			uni.shareWithSystem({
				summary: '精品腕表,尽在TopTime',
				href: 'https://toptimeclub.com/' + code,
				success() {},
				fail() {},
			});
			/*#endif*/
