					...
					<view class="mine-title">
						...
						<view class="search-input">
							<input type="text" style="width: 100%;" v-model="keyword" placeholder="搜索" confirm-type="search"
								placeholder-style="color: #C0C5CE;font-size: 24rpx;" @confirm="searchInput"/>
							<uni-icons type="search" size="20" color="#7b7b7b" @click="searchInput"></uni-icons>
						</view>
					</view>
				</view>
			...
			<view v-else>
				<view class="product-list">
					<view class="item" v-for="(item, index) in bagSearchList" :key="index">
						...
						<image class="specialImg" v-if="item.isAuction == 1" :src="getSpecialImg(item)" mode="aspectFill"></image>
