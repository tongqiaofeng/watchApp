...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"TopTime","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 110:
/*!**********************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/mine/avatar.png ***!
  \**********************************************************************/
/*! no static exports found */
...
/***/ 12:
/*!************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/js/chat.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var Chat = /*#__PURE__*/function () {


  function Chat(chatServerUrl, appID, userListRoute, userChatRoute, chatTabIdx) {_classCallCheck(this, Chat);
    //帐号信息
    this.userId = '';
    this.token = '';
    this.cid = '';
  ...
  }_createClass(Chat, [{ key: "setUserInfo", value: function setUserInfo(

    userId, token, userName, headPic) {
    ...
    } }, { key: "isSelf", value: function isSelf(

    userId) {
      //alert(this.userId + '_'+userId);
      if (this.userId == userId) return true;else
      return false;
    } }, { key: "setCurChatUserId", value: function setCurChatUserId(
    ...
    ///连接服务器
  }, { key: "connectServer", value: function connectServer() {var _this = this;
      ...
      uni.onSocketOpen(function (res) {
        ...
        _this.g_socketLiveTime = new Date().getTime();
        that.checkinServer();
    ...
    } }, { key: "closeConnect", value: function closeConnect()
    ...
    //重连
  }, { key: "reConnectServer", value: function reConnectServer() {
      this.g_socketLiveTime = 0;
    }

    //发送心路包
  }, { key: "checkinServer", value: function checkinServer() {
      var that = this;
      var msg = {
        type: "checkin",
        cid: this.cid };
    ...
    //更新用户名和头像
  }, { key: "updateUserInfo", value: function updateUserInfo() {
    ...
    //处理接收到的消息
  }, { key: "recvFromServer", value: function recvFromServer() {var _this2 = this;
      ...
      uni.onSocketMessage(function (res) {
        ...
        if (data.type == 'checkin-success') {
          ...
          if (_userIdx > -1) {
            if (_this2.userList[_userIdx].num > 0)
            _this2.readMsgCmd(_this2.curChatUserId);
    ...
    //处理新消息
  }, { key: "recvNewMsg", value: function recvNewMsg(data) {
    ...
    //根据msgInfo查找消息
  }, { key: "findMsg", value: function findMsg(userIdx, msgInfo) {
  ...
  }, { key: "findUser", value: function findUser(userId) {
    ...
    //获取用户note
  }, { key: "getUserNote", value: function getUserNote(userId) {
      var note = '';
      ...
      return note;
    } }, { key: "admin_findmsg", value: function admin_findmsg(
    ...
    //发送消息
  }, { key: "sendToServer", value: function sendToServer(msg) {
    ...
    //发送提取用户列表命令
  }, { key: "updateUserListCmd", value: function updateUserListCmd() {
      var msg = {
      ...
      this.userList = [];
      this.sendToServer(msg);
    } }, { key: "updateAdminListCmd", value: function updateAdminListCmd()
    {
      var msg = {
        type: "historyAdmin" };
      ...
      this.adminList = [];
      this.sendToServer(msg);
    } }, { key: "deleteAdminList", value: function deleteAdminList(
    data) {
      var msg = {
        type: "deleteAdmin",
        id: data.id };
      ...
      this.sendToServer(msg);
    } }, { key: "sendAdminList", value: function sendAdminList(
    type, content) {
      var msg = {
        type: "messageAdmin",
        receiver: userId,
      ...
      this.sendToServer(msg);
    } }, { key: "updateUserMsg", value: function updateUserMsg(
    ...
    userId) {
      ...
      if (userIdx > -1) {
        ...
        msgListSendMark)
        this.getMsgHistoryCmd(userId, false);else
        {
    ...
    //发送提取聊天记录命令:loadMore
  }, { key: "getMsgHistoryCmd", value: function getMsgHistoryCmd(userId) {var loadMore = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var msgStartId = 0;
      var userIdx = this.findUser(userId);
      if (userIdx > -1) {
        if (loadMore) {
    ...
    //给指定用户发送消息
  }, { key: "sendMsgToUserCmd", value: function sendMsgToUserCmd(userId, content, type) {
      var msg = {
        type: "message",
        receiver: userId,
        contentType: type,
    ...
    //更新消息状态
  }, { key: "updateMsgState", value: function updateMsgState(data) {
    ...
    //发送消息已读命令
  }, { key: "readMsgCmd", value: function readMsgCmd(userId) {
      var msg = {
        type: "read",
        userId: userId };
    ...
    //已阅读消息
  }, { key: "readMsgSuccess", value: function readMsgSuccess(data) {
    ...
    //删除消息命令
  }, { key: "deleteMsgCmd", value: function deleteMsgCmd(userId, msgId) {
      var msg = {
        type: "delete",
        receiver: userId,
        id: msgId };
    ...
    //获取用户信息
  }, { key: "getUserInfoCmd", value: function getUserInfoCmd(userId) {
      var msg = {
        type: "user",
        userId: userId };
    ...
    //更新用户头像
  }, { key: "updateUserPic", value: function updateUserPic(data) {
    ...
    //获取当前页面
  }, { key: "getCurPage", value: function getCurPage() {
      var pages = getCurrentPages(); // 获取栈实例
      var currentRoute = pages[pages.length - 1].route;
      if (currentRoute == this.userListRoute)
      return 'list';else
      if (currentRoute == this.userChatRoute)
      return 'chat';else
    ...
    //刷新页面
  }, { key: "updatePage", value: function updatePage(page) {
    ...
    } }, { key: "getMsgUUID", value: function getMsgUUID()

    {
      ...
      var uuid = s.join("");
      return uuid;
    } }, { key: "updateReddot", value: function updateReddot()
    ...
    } }]);return Chat;}();exports.default = Chat;
...
/***/ 162:
/*!**************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/details/collect.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 163:
/*!****************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/details/collect01.png ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 290:
/*!**********************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 298:
/*!*************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-forms/components/uni-forms/validate.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 341:
/*!*************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-search-bar/components/uni-search-bar/i18n/index.js ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 342:
/*!************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-search-bar/components/uni-search-bar/i18n/en.json ***!
  \************************************************************************************************************/
...
/***/ 343:
/*!*****************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hans.json ***!
  \*****************************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 344:
/*!*****************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hant.json ***!
  \*****************************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 352:
/*!***********************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/index.js ***!
  \***********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 353));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 354));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 355));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
/***/ 353:
/*!**********************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/en.json ***!
  \**********************************************************************************************************************/
...
/***/ 354:
/*!***************************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/zh-Hans.json ***!
  \***************************************************************************************************************************/
...
/***/ 355:
/*!***************************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/zh-Hant.json ***!
  \***************************************************************************************************************************/
/*! exports provided: uni-datetime-picker.selectDate, uni-datetime-picker.selectTime, uni-datetime-picker.selectDateTime, uni-datetime-picker.startDate, uni-datetime-picker.endDate, uni-datetime-picker.startTime, uni-datetime-picker.endTime, uni-datetime-picker.ok, uni-datetime-picker.clear, uni-datetime-picker.cancel, uni-calender.SUN, uni-calender.MON, uni-calender.TUE, uni-calender.WED, uni-calender.THU, uni-calender.FRI, uni-calender.SAT, default */
/***/ (function(module) {
...
/***/ 37:
/*!************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/js/time.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 412:
/*!******************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 418:
/*!*****************************************************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/uni_modules/uni-datetime-picker/components/uni-datetime-picker/util.js ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 5:
/*!*****************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/pages.json ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 62:
/*!********************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/search/up.png ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 63:
/*!**********************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/search/down.png ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 64:
/*!************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/search/normal.png ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 65:
/*!*********************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/search/yes.png ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 66:
/*!********************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/search/no.png ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 83:
/*!*************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/service/WeChat.png ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 84:
/*!***************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/service/WhatsApp.png ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 85:
/*!****************************************************************************!*\
  !*** G:/aa-tong/my-project/watchApp_Web/static/imgs/service/Instagram.png ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
