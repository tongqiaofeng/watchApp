<template>
	<view class="detail" v-if="isShow">
		...
		<view class="detail-top">
			...
			<view class="name" @longpress="getCopyContent(detail.model)">
				{{ detail.model }}
			</view>
			<view class="note">
		...
		<view class="product-parameter" v-if="tabSelType == 0">
			...
			<view class="parameter-main">
				<view class="parameter-every" v-if="isOther(detail.brand)">
					<text class="title">品牌</text>
					<text class="container">{{ detail.brand }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.series)">
				...
				<view class="parameter-every" v-if="detail.special.length > 1">
					...
					<text class="container">{{ detail.special }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.movementType)">
					<text class="title">机芯类型</text>
					<text class="container">{{ detail.movementType }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.dialSize)">
					<text class="title">表盘大小</text>
					<text class="container">{{ detail.dialSize }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.crownMaterial)">
					<text class="title">表壳材质</text>
					<text class="container">{{ detail.crownMaterial }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.waterproof)">
					<text class="title">防水深度</text>
					<text class="container">{{ detail.waterproof }}米</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.func)">
					<text class="title">功能</text>
					<text class="container">{{ detail.func }}</text>
				</view>
				<view class="parameter-every" v-if="isOther(detail.startYear)">
